...
## C/Asm 
### Procuder-Consumer
- **Ссылка на репозиторий**: [producer-consumer](https://github.com/lubitelkvokk/producer_consumer)
...
- **Описание**: Репозиторий содержит решение задачи вычисления суммы массива чисел методом producer-consumer, в результате чего вычисления распараллеливаются и собираются в единую сумму после.
